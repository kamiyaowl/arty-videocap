...
HD_PWD='C:/Users/user/repos/arty-videocap/vivado/arty-videocap.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CAPTURE.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CAPTURE.tcl -notrace
