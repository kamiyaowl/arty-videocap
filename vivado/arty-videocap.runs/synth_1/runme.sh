...
HD_PWD='C:/Users/user/repos/arty-videocap/vivado/arty-videocap.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CAPTURE.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CAPTURE.tcl
